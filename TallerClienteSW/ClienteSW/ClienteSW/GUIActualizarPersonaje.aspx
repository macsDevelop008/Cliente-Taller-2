<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GUIActualizarPersonaje.aspx.cs" Inherits="ClienteSW.GUIActualizarPersonaje" %>
    ...
    <div class="container-fluid">
      ...
      <div class="container well contenedor" >
        ...
        <asp:Label ID="Label7" runat="server" Text="Id: " CssClass="control-label col-sm-2"></asp:Label>
            ...
            <div class="form-group">
        <asp:Label ID="Label2" runat="server" Text="Nombre: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control"></asp:TextBox>
        </div>  
                <div class="form-group">
        <asp:Label ID="Label3" runat="server" Text="Fuerza: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                <asp:TextBox ID="txtFuerza" runat="server" CssClass="form-control"></asp:TextBox>
        </div>  
                    <div class="form-group">
        <asp:Label ID="Label4" runat="server" Text="Mana: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                <asp:TextBox ID="txtMana" runat="server" CssClass="form-control"></asp:TextBox>
        </div>  
          <div class="form-group">
        <asp:Label ID="Label6" runat="server" Text="Energia: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                <asp:TextBox ID="txtEnergia" runat="server" CssClass="form-control"></asp:TextBox>
        </div> 

           <div class="form-group">
        <asp:Label ID="Label5" runat="server" Text="Especie: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                <asp:TextBox ID="txtEspecie" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
          <div>
          <asp:Label ID="Label1" runat="server" Text="Jugador: " CssClass="control-label col-sm-2"></asp:Label>
              </div>
            <div class="form-group">
        ...
        <br />
        <div class="form-group">
            <asp:Button ID="btnEliminar" runat="server" Text="Actualizar Personaje" CssClass="form-control btn btn-primary" BackColor="Black" OnClick="btnEliminar_Click"  />
        </div>

          <br />
        <div class="form-group">
            <asp:Button ID="btnBuscar" runat="server" Text="Buscar Personaje" CssClass="form-control btn btn-primary" BackColor="Black" OnClick="btnBuscar_Click"  />
        </div>
          </div>
