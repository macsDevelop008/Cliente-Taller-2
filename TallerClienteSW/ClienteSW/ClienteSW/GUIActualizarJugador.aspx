<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GUIActualizarJugador.aspx.cs" Inherits="ClienteSW.GUIActualizarJugador" %>
   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Fourth navbar example">
    <div class="container-fluid">
      ...
      <div class="container well contenedor" >
        ...
        <br />
        <div class="form-group">
            <asp:Button ID="btnCrear" runat="server" Text="Actualizar Jugador" CssClass="form-control btn btn-primary" BackColor="Black" OnClick="btnCrear_Click"  />
        </div>
         <br />
        <div class="form-group">
