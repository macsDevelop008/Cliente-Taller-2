<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GUICrearPersonaje.aspx.cs" Inherits="ClienteSW.WebForm1" %>
      ...
      <div class="container well contenedor" >
        ...
        <asp:Label ID="Label5" runat="server" Text="Especie: " CssClass="control-label col-sm-2"></asp:Label></div>
            <div class="form-group">
                ...
                <asp:DropDownList runat="server" ID="ListEspe" Width="1163px"  />
          ...
          <asp:Label ID="Label1" runat="server" Text="Jugador: " CssClass="control-label col-sm-2"></asp:Label>
            ...
            <div class="form-group">
                ...
                <asp:DropDownList runat="server" ID="ListJuga" Width="1163px" />
          </div>
        <br />
        <div class="form-group">
            <asp:Button ID="btnCrear" runat="server" Text="Crear Jugador" CssClass="form-control btn btn-primary" BackColor="Black" OnClick="btnCrear_Click"  />
        </div>
          </div>
