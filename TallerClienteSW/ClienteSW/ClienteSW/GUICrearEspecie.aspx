<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GUICrearEspecie.aspx.cs" Inherits="ClienteSW.GUIAgregarEspecie" %>
   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Fourth navbar example">
    <div class="container-fluid">
      ...
      <div class="container well contenedor" >
        ...
        <br />
        <div class="form-group">
            <asp:Button ID="btnCrear" runat="server" Text="Crear Especie" CssClass="form-control btn btn-primary" BackColor="Black" OnClick="btnCrear_Click"  />
        </div>
          </div>
